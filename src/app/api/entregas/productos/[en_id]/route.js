...
export async function GET(request, { params }) {
  try {
    ...
    const sql = `SELECT entregas.en_id, productos.*,entrega_producto.en_produc_precio, entrega_producto.en_produc_estado, entrega_producto.en_produc_oferta, entrega_producto.en_produc_cantidad
...
export async function DELETE(request, { params }) {
  try {
    ...
    if (result.affectedRows > 0) {
      return NextResponse.json({ message: "Fila eliminada" }, { status: 200 });
    } else {
